...
urlpatterns = [
    ...
    path('fulload_list', views.fulload_list, name='fulload_list'),

    path('get_full_load_data', views.get_full_load_data, name='get_full_load_data'),
    path('fulload_invoice/<str:transport>/', views.fulload_invoice, name='fulload_invoice'),
    ...
    path('full-load-invoice/<int:pk>/', views.fullLoadInvoice, name='fullLoadInvoice'),
    path('invoice/<str:sender_name>/', views.generate_invoice, name='generate_invoice'),
